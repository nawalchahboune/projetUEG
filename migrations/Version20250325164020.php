 ...
 */
final class Version20250325164020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wishlist ADD collaboration_token VARCHAR(36) DEFAULT NULL, ADD public_token VARCHAR(36) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wishlist DROP collaboration_token, DROP public_token');
